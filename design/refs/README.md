# D1.1 reference boards (generated 2026-07-04)

Generated with Higgsfield `nano_banana_pro` (served as `nano_banana_2`, 1376×768) via the
`taste-skill:imagegen-frontend-web` skill, one image per surface per plan §D1.1, prompts
locked to design.md's palette/type/anti-generic law. **Status: candidates awaiting Chris's
acceptance** — plan §D1.1 says the *accepted* directions get codified; these are the
proposals.

| File | Surface | Notes |
|---|---|---|
| `d1.1-greeting.png` | Landing / paste | On-spec: wordmark, time-of-day greeting, journal textarea hero, stamped `--soup` button, Gracie waving, pencil-note how-it-works. |
